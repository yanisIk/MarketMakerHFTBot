...
export default class BittrexMarketMakerBot {
    ...
    setUpPipeline() {
        ...
        this.openOrdersStatusDetector = new OpenOrdersStatusDetector(this.broker, CONFIG.BITTREX.ORDER_WATCH_INTERVAL_IN_MS);
        ...
        this.sellFilledHandler = new SellFilledEventHandler(this.openOrdersStatusDetector, this.tickEmitter, this.broker);
    }
    start() {
        return;
        // let startQuantity = 0;
