 ...
 */
var OutAskEventHandler = /** @class */ (function () {
    function OutAskEventHandler(tickEventEmitter, outAskDetector, broker) {
        this.tickEventEmitter = tickEventEmitter;
        this.outAskDetector = outAskDetector;
        this.broker = broker;
        this.startMonitoring();
    }
    OutAskEventHandler.prototype.startMonitoring = function () {
        var _this = this;
        this.outAskDetector.on(OutAskDetector_1["default"].OUTASK_ORDER_EVENT, function (order) { return __awaiter(_this, void 0, void 0, function () {
            var _this = this;
    ...
    OutAskEventHandler.prototype.generateOutAskQuote = function (order, tick) {
        var newAsk = tick.ask - (tick.spread * 0.01);
        return new Quote_1["default"](order.marketName, newAsk, order.quantityRemaining, Order_1.OrderSide.SELL, Order_1.OrderType.LIMIT, Order_1.OrderTimeEffect.GOOD_UNTIL_CANCELED);
    };
    return OutAskEventHandler;
}());
exports["default"] = OutAskEventHandler;
